...
- **Obiwan.exe:** The first executable was only sending two messages, but they were not so special.
  ...
  <img src="https://i.imgur.com/jVKEx8S.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
- **Obiwan2.exe:** The second executable sent three messages.
  ...
  <img src="https://i.imgur.com/v8L3PZM.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
...
<img src="https://i.imgur.com/6OfIDRE.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
...
<img src="https://i.imgur.com/5lXXVEN.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
